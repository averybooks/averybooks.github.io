...
* Python Machine Control and Software Development
* Python Data Analysis and Statistical Analysis
* Radio Interferometry
* Github and Version Control
* Root Cause Analysis
* ANSYS Optimax Simulation Software
* Quantum Computation Error Correction Architecture and Theory
* Research and Report Writing

### Soft Skills
* Cross-Department Coordination
* Scientific Public Speaking
* Team Leadership and Logistics
