...
<div class="row">
  <div class="medium-8 columns">
    <h2>Full Report</h2>
    <iframe src="{{ site.url }}/assets/pdfs/Resource Cost of Shor_s Quantum Algorithm Paper.pdf" width="100%" height="600px"></iframe>
  </div>
  ...
  <div class="medium-4 columns" style="background: #f4f4f4; padding: 20px; border-radius: 5px;">
    ...
    <ul>
      ...
      <li><strong>Lab:</strong> Physics C191A</li>
      <li><strong>Topic:</strong> Quantum Computing Resource Costs</li>
    </ul>
    <a href="{{ site.url }}/assets/pdfs/Resource Cost of Shor_s Quantum Algorithm Paper.pdf" class="button small expand">Download Full PDF</a>
  </div>
</div>